...
//  triadic
function triadic(base, colors) {
  colors[0].h = base.h - 30;
  colors[1].h = base.h + 30;
  colors[2].l = base.l - 20;
  colors[3].s = base.s + 30;
}

// complementary
function complementary(base, colors) {
  colors[0].h = base.h - 20;
  colors[1].s = base.s + 10;
  colors[2].h = base.h - 40;
  colors[3].h = base.h + 40;
}

// compound
function compound(base, colors) {
  colors[0].h = base.h - 30;
  colors[1].h = base.h - 60;
  colors[2].h = base.h + 40;
  colors[3].h = base.h - 20;
}

// shades
function shades(base, colors) {
  colors[0].h = base.h + 60;
  colors[1].s = base.s + 60;
  colors[2].l = base.l + 60;
  colors[3].l = base.l - 30;
}
...
function setHarmony(harmony) {
  ...
  switch (harmony) {
    ...
    case "triadic":
      settings.harmony = triadic;
      break;

    case "complementary":
      settings.harmony = complementary;
      break;

    case "compound":
      settings.harmony = compound;
      break;

    case "shades":
      settings.harmony = shades;
      break;
  }
